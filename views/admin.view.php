		...
		<div class="row container">
			<div class="col s12 hide-print">
				<ul class="tabs tabs-fixed-width" style="background-color: transparent; color: white;">
			        ...
			        <?php if ($new_sups): ?>
					<li class="tab col s3"><a style="font-size: 1.4em; color:  #ee6e73;" class="waves-effect waves-cyan hoverable" href="#new"><i class="fa fa-home"></i> <span> New Suppliers</span></a></li>
				<?php endif ?>
				    ...
				    <li class="tab col s3"><a style="font-size: 1.4em; color:  #ee6e73;" class="waves-effect waves-cyan hoverable" href="#admins"><i class="fa fa-folder-open"></i> <span> Administration</span></a></li>
				...
				<div class=" panel cyan-text ">
					<div class="row">
						<div class="col l3 m3 right-align">
							<h1 class="xxl-text"><i class="fa fa-users"></i></h1>
						</div>
						<div class="col l9 m8 center-align">
							<h2>New Suppliers</h2>
							<h6>Approve new suppliers here.</h6>
						</div>
					</div>
					...
					<div class="row">
						<table class="highlight responsive-table centered">
						    ...
						    <tbody>
						    <?php foreach ($new_sups as $new_sup): ?>
								<tr>
						    		<td><?=ucwords($new_sup['fname']." ".$new_sup['lname'])?></td>
						    		<td><?=$new_sup['c_email']?></td>
						    		<td><?=$new_sup['phone']?></td>
						    		<td><?=ucwords($new_sup['c_name'])?></td>
						    		<td>
						    			<a target="_blank" href="../<?=$new_sup['c_cert']?>"> <i class="fa fa-file-text-o"></i> Download Cert</a> <br>
						    			<a target="_blank" href="../<?=$new_sup['c_pin']?>"> <i class="fa fa-file-o"></i> Download K.R.A PIN</a> <br>
						    			<a target="_blank" href="../<?=$new_sup['c_profile']?>"><i class="fa fa-file-pdf-o"></i> Download Profile</a>
						    		</td>
						    		<td>
						    			<a class="btn-flat cyan white-text" href="approve_supplier.php?id=<?=$new_sup['idno'] ?>"> Approve Supplier</a>

						    			<a class="btn-flat red white-text" href="delete_supplier.php?id=<?=$new_sup['idno'] ?>"> Delete Supplier</a>
						    		</td>
						    	</tr>
							<?php endforeach ?>
